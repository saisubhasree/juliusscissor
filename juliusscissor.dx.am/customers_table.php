			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item">
					...
					<a class="nav-link" href="appointments_table.php">APPOINTMENTS</a>
                                ...
                                <li class="nav-item">
					<a class="nav-link active" href="customers_table.php">CUSTOMERS</a>
				</li>
                                <li class="nav-item">
...
<?php
// SQL to retreive all the customer data
$cust = "SELECT * from customers ORDER BY customer_id DESC;";

$customers = mysqli_query($conn, $cust);
...
<?php
//loop through all data and echo it into the table
