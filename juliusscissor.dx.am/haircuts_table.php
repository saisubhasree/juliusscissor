			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item">
					...
					<a class="nav-link" href="customers_table.php">CUSTOMERS</a>
                                ...
                                <li class="nav-item">
					<a class="nav-link active" href="haircuts_table.php">HAIRCUTS</a>
				</li>
                                <li class="nav-item">
...
<?php
//retreive data on all the haircuts
...
<div class="w3-container">
  <center><h2>Haircuts</h2>
<div class="scrollable">
  <table class="w3-table-all w3-card-4 w3-round-large">
    <tr>
      <th>haircut_id</th>
      <th>haircut_name</th>
      <th>haircut_sample_url</th>
    </tr>
    
<?php
//loop through the received data and echo it into the table
while($result = mysqli_fetch_assoc($results)) {
	$haircut_id = $result['haircut_id'];
	$haircut_name = $result['haircut_name'];
	$haircut_sample_url = $result['haircut_sample_url'];
?>
    
    <tr>
      <td><?php echo $haircut_id?></td>
      <td><?php echo $haircut_name?></td>
      <td><?php echo $haircut_sample_url?></td>
    </tr>
