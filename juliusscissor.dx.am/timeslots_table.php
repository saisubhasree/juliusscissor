			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item">
					...
					<a class="nav-link" href="hairstylists_table.php">HAIRSTYLISTS</a>
                                ...
                                <li class="nav-item">
					<a class="nav-link active" href="timeslots_table.php">TIMESLOTS</a>
				</li>
			</ul>
		</div>
	</div>
...
<?php
//SQL query to retreive data on all the timeslots
...
<div class="w3-container">
  <center><h2>Timeslots</h2>
<div class="scrollable">
  <table class="w3-table-all w3-card-4 w3-round-large">
    <tr>
      <th>timeslot_id</th>
      <th>timeslot_duration</th>
    </tr>
    
<?php
//loop through the data and echo it into the table
while($result = mysqli_fetch_assoc($results)) {
	$timeslot_id = $result['timeslot_id'];
	$timeslot_duration = $result['timeslot_duration'];
?>
